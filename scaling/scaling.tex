...
\parpic[r]{\includegraphics[width=0.6\textwidth]{./scaling/figs/bee-flying}}
...
&
\begin{minipage}{150pt}
\frame{\includegraphics[width=0.4\textwidth]{./scaling/figs/boat-3}}
...
\parpic[r]{\includegraphics[width=0.25\textwidth]{./scaling/figs/clay} \label{clay}}
...
\parpic[r]{\includegraphics[width=0.4\textwidth]{./scaling/figs/muffin} \label{muffin}}
...
\parpic[r]{\includegraphics[width=0.3\textwidth]{./scaling/figs/jelly-beans_1.jpg} \label{jelly-beans}}
...
\parpic[r]{\includegraphics[width=0.2\textwidth]{./scaling/figs/spherical-cow} \label{spherical-cow}}
...
\piccaption{ \qquad }
\parpic[r]{\includegraphics[width=0.4\textwidth]{./scaling/figs/amphicoelias}}
...
\parpic[r]{\includegraphics[width=0.3\textwidth]{./scaling/figs/einstein} \label{hairmass}}
...
\parpic[r]{\includegraphics[width=0.3\textwidth]{./scaling/figs/hw-liter-cube} \label{liter-cube}}
...
\parpic[r]{\includegraphics[width=0.4\textwidth]
...
\parpic[r]{\includegraphics[width=0.4\textwidth]{./scaling/figs/seti-volume} \label{seti-volume}}
...
\parpic[r]{\includegraphics[width=0.24\textwidth]{./scaling/figs/oranges.jpg}\label{hw:golf-ball-packing}}
